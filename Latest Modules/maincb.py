...
#Initializing files
filename = f'{program_path}sherlock-project-master/QGD/IndyHub Datasets/File1/data1.csv'
datad = f'{program_path}sherlock-project-master/QGD/IndyHub Datasets/File1/datadescription1.txt'
cold = f'{program_path}sherlock-project-master/QGD/IndyHub Datasets/File1/datacolumn1.csv'
