...
#        operator_key = operator_key[0]
    ...
    if (sql[6] == "Minimum"):
        ...
        if a1 == 1:
            ...
            #sq = sqtemp.format(operator_key, sql[5], sql[1], str(value1))
            ...
            #sqtemp = "SELECT {}, {}{} AS {}_{} FROM df GROUP BY {};"
            #sq = sqtemp.format(sql[1], operator_key,  operator_key.lower(), sql[5], sql[1])
        ...
        if a2 == 1:
            ...
            #sqtemp = "SELECT {}{} FROM df WHERE {} = {}"
            #sq = sqtemp.format(operator_key, sql[5], sql[1], value1)
        ...
        sq = sqtemp.format(sql[5], sql[1], value3, sql[5])            
