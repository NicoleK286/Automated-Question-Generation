...
def quesv3(sql,col,df,sher_pred):
    ...
    try:
        if (sql[6] in ("Equal to", "Not Equal to", "Lesser than", "Greater than")) and (sql[10] in ("Equal to", "Not Equal to", "Lesser than", "Greater than")):
            ...
            a3 = random.randint(0,1)
            if a3 == 0:
                template = "For a given value of {}, where the average of {} is lesser than {}, what is the {} value of {}, within the dataset?"
                q1 = template.format(sql[1],      sql[5],    str(sql[7]),  sql[10], sql[9])
                que = template.format(des1,       des2,      str(sql[7]),  sql[10], des3)
                que2 = template.format(des1_para, des2_para, str(sql[7]),  sql[10], des3_para)
            else:
                template = "For a given value of {}, where the average of {} is higher than {}, what is the {} value of {}, within the dataset?"
                q1 = template.format(sql[1],      sql[5],    str(sql[7]),  sql[10], sql[9])
                que = template.format(des1,       des2,      str(sql[7]),  sql[10], des3)
                que2 = template.format(des1_para, des2_para, str(sql[7]),  sql[10], des3_para)
            ...
            template = "For a given value of {}, what are the average values of {} and {}, within the dataset?"
            ...
            if a3 == 0:
                template = "For a given value of {}, where the average of {} is lesser than {}, what is the {} value of {}, within the dataset?"
                q1 = template.format(sql[1],      sql[9],    str(sql[7]),  sql[10], sql[5])
                que = template.format(des1,       des3,      str(sql[7]),  sql[10], des2)
                que2 = template.format(des1_para, des3_para, str(sql[7]),  sql[10], des2_para)
            else:
                template = "For a given value of {}, where the average of {} is higher than {}, what is the {} value of {}, within the dataset?"
                q1 = template.format(sql[1],      sql[9],    str(sql[7]),  sql[10], sql[5])
                que = template.format(des1,       des3,      str(sql[7]),  sql[10], des2)
            ...
            a3 = random.randint(0,1)
            if a3 == 0:
                template = "For a given value of {}, where the average of {} is lesser than {}, how many records of {} are present within the dataset?"
                q1 = template.format(sql[1],      sql[5],    str(sql[7]),  sql[9])
                que = template.format(des1,       des2,      str(sql[7]),  des3)
                que2 = template.format(des1_para, des2_para, str(sql[7]),  des3_para)
            else:
                template = "For a given value of {}, where the average of {} is higher than {}, how many records of {} are present within the dataset?"
                q1 = template.format(sql[1],      sql[5],    str(sql[7]),  sql[9])
                que = template.format(des1,       des2,      str(sql[7]),  des3)
                que2 = template.format(des1_para, des2_para, str(sql[7]),  des3_para)
            ...
            template = "For a given value of {}, where the {} of {} is {}, what is the total number of records for {}, in the dataset?"
            q1 = template.format(sql[1],      sql[5],    sql[6], str(sql[7]), sql[9]    )
            que = template.format(des1,       des2,      sql[6], str(sql[7]), des3      )
            que2 = template.format(des1_para, des2_para, sql[6], str(sql[7]), des3_para )

        elif (sql[10] in ("Equal to", "Not Equal to", "Lesser than", "Greater than")) and (sql[6] == "COUNT"):
            template = "For a given value of {}, where the {} of {} is {}, what is the total number of records for {}, in the dataset?"
            q1 = template.format(sql[1],      sql[9],    sql[10], str(sql[11]), sql[5]    )
            que = template.format(des1,       des3,      sql[10], str(sql[11]), des2      )
            que2 = template.format(des1_para, des3_para, sql[10], str(sql[11]), des2_para )


        elif (sql[6] == "COUNT") and (sql[10] == "Minimum"):
            template = "For a given value of {}, how many records of {} are present, for the lowest value of {}, in the dataset?"
            q1 = template.format(sql[1],      sql[5],    sql[9])
            que = template.format(des1,       des2,      des3)
            que2 = template.format(des1_para, des2_para, des3_para)
        elif (sql[6] == "COUNT") and (sql[10] =="Maximum"):
            template = "For a given value of {}, how many records of {} are present, for the highest value of {} in the dataset?"
            q1 = template.format(sql[1],      sql[5],    sql[9])
            que = template.format(des1,       des2,      des3)
            que2 = template.format(des1_para, des2_para, des3_para)
            ...
            template = "For a given value of {}, how many records of {} are present, for the lowest value of {} in the dataset?"
            q1 = template.format(sql[1],      sql[9],    sql[5])
            que = template.format(des1,       des3,      des2)
            que2 = template.format(des1_para, des3_para, des2_para)
            ...
            template = "For a given value of {}, how many records of {} and {} are present, in the dataset?"
            q1 = template.format(sql[1],      sql[9],    sql[5])
            que = template.format(des1,       des3,      des2)
            que2 = template.format(des1_para, des3_para, des2_para)
            ...
            template = "For a given value of {}, where {} is {} {}, what is the lowest value of {}, in the dataset?"
            q1 = template.format(sql[1],      sql[5],    sql[6], str(sql[7]), sql[9]    )
            que = template.format(des1,       des2,      sql[6], str(sql[7]), des3      )
            que2 = template.format(des1_para, des2_para, sql[6], str(sql[7]), des3_para ) 

        elif (sql[6] == "Minimum") and (sql[10] in ("Equal to", "Not Equal to", "Lesser than", "Greater than")):
            template = "For a given value of {}, what is the lowest value of {} in the dataset, when {} is {} {}?"
            q1 = template.format(sql[1],      sql[5],    sql[9],    sql[10], str(sql[11]))
            que = template.format(des1,       des2,      des3,      sql[10], str(sql[11]))
            que2 = template.format(des1_para, des2_para, des3_para, sql[10], str(sql[11]))


        elif (sql[6] in ("Equal to", "Not Equal to", "Lesser than", "Greater than")) and (sql[10] == "Maximum"):
            template = "For a given value of {}, where {} is {} {}, what is the highest value of {}, in the dataset?"
            q1 = template.format(sql[1],      sql[5],    sql[6], str(sql[7]), sql[9]    )
            que = template.format(des1,       des2,      sql[6], str(sql[7]), des3      )
            que2 = template.format(des1_para, des2_para, sql[6], str(sql[7]), des3_para )

        elif (sql[6] == "Maximum") and (sql[10] in ("Equal to", "Not Equal to", "Lesser than", "Greater than")):
            template = "For a given value of {}, what is the highest value of {} in the dataset, when {} is {} {}?"
            q1 = template.format(sql[1],      sql[5],    sql[9],    sql[10], str(sql[11]))
            que = template.format(des1,       des2,      des3,      sql[10], str(sql[11]))
            que2 = template.format(des1_para, des2_para, des3_para, sql[10], str(sql[11]))
