...
# Initializing files
filename = f'{program_path}sherlock-project-master/QGD/Main3 Running Examples/FIPS Ex3/datafips3.csv'
datad = f'{program_path}sherlock-project-master/QGD/Main3 Running Examples/FIPS Ex3/dataDescriptionfips3.txt'
cold = f'{program_path}sherlock-project-master/QGD/Main3 Running Examples/FIPS Ex3/dataColumnfips3.csv'
...
if inp == 1:
    ...
    # Save the initial DataFrame to an Excel file with folder name included
    output_filename_initial1 = f"{program_path}sherlock-project-master/QGD/IndyHub Datasets/Main 11 Program Output/{folder_name}_questions_m11v2.xlsx"
    output_df1.to_excel(output_filename_initial1, index=False)

    output_filename_initial2 = f"{program_path}sherlock-project-master/QGD/IndyHub Datasets/Main 11 Program Output/{folder_name}_questions_m11v3.xlsx"
