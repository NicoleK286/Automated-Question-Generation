...
#Initializing files
filename = '/N/u/nickoshy/Carbonate/Sherlock/sherlock-project-master/QGD/Main3 Running Examples/FIPS Ex4/datafips4.csv'
datad = '/N/u/nickoshy/Carbonate/Sherlock/sherlock-project-master/QGD/Main3 Running Examples/FIPS Ex4/dataDescriptionfips4.txt'
cold = '/N/u/nickoshy/Carbonate/Sherlock/sherlock-project-master/QGD/Main3 Running Examples/FIPS Ex4/dataColumnfips4.csv'
...
if x == 0:
    ...
    for i in range(0,len(columnd)):
        temp = list(columnd.iloc[i,2])  #Since the column description in the second column we are adding the column number as "2"
    # print(temp[0])filee
        filee = filee + temp #concatenating only column description (column name not included) and data description file

    with open('/N/u/nickoshy/Carbonate/Sherlock/sherlock-project-master/QGD/Main3 Running Examples/FIPS Ex4/dataDescriptionfips4.txt', 'r+') as f:
        for line in filee:
