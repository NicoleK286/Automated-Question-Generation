...
from questn8 import ques   # question generation 
import random
from para2 import *
...
# Initializing files
filename = f'{program_path}sherlock-project-master/QGD/Main3 Running Examples/Ex11 Mdc/data11.csv'
datad = f'{program_path}sherlock-project-master/QGD/Main3 Running Examples/Ex11 Mdc/dataDescription11.txt'
cold = f'{program_path}sherlock-project-master/QGD/Main3 Running Examples/Ex11 Mdc/dataColumn11.csv'


#Initializing files
#filename = f'{program_path}sherlock-project-master/QGD/IndyHub Datasets/File26/OES_Emp_Wage_IN2022_data.xlsx'
#datad = f'{program_path}sherlock-project-master/QGD/IndyHub Datasets/File26/OES_Emp_Wage_IN2022_dataDescription.txt'
#cold = f'{program_path}sherlock-project-master/QGD/IndyHub Datasets/File26/OES_Emp_Wage_IN2022_dataColumn.xlsx'
...
output_filename_initial = f"{program_path}sherlock-project-master/QGD/IndyHub Datasets/Main 9 Program Output/{folder_name}_datatype_analysis_m10v2.xlsx"
...
if inp == 1:
    ...
    # Save the initial DataFrame to an Excel file with folder name included
    output_filename_initial1 = f"{program_path}sherlock-project-master/QGD/IndyHub Datasets/Main 9 Program Output/{folder_name}_questions_m10v2.xlsx"
...
# Save the initial DataFrame to an Excel file with folder name included
#output_filename_initial1 = f"C:/Users/Nicole/sherlock-project-master/QGD/IndyHub Datasets/Main 9 Program Output/{folder_name}_questions_m10.xlsx"
#output_df.to_excel(output_filename_initial1, index=False)
