...
#Initializing files
filename = f'{program_path}sherlock-project-master/QGD/IndyHub Datasets/File6/data6.csv'
datad = f'{program_path}sherlock-project-master/QGD/IndyHub Datasets/File6/datadescription6.txt'
cold = f'{program_path}sherlock-project-master/QGD/IndyHub Datasets/File6/datacolumn6.csv'
...
output_filename_initial = f"{program_path}sherlock-project-master/QGD/IndyHub Datasets/Main 11 Program Output/{folder_name}_datatype_analysis_m11b.xlsx"
...
if inp == 1:
    ...
    while g == 'y' and question_count < 20:
        ...
        while counter in range(0, 5):
            if question_count < 20:
                ...
                q1, que, para, que2, para2, best_version, sq, result = "", "", "", "", "", "", "", ""  # Initialize the variables
    ...
    # Save the initial DataFrame to an Excel file with folder name included
    output_filename_initial1 = f"{program_path}sherlock-project-master/QGD/IndyHub Datasets/Main 11 Program Output/{folder_name}_questions_m11b.xlsx"
