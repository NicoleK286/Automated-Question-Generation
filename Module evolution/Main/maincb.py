...
#Initializing files
filename = f'{program_path}sherlock-project-master/QGD/IndyHub Datasets/File29/svi_percentile.xlsx'
datad = f'{program_path}sherlock-project-master/QGD/IndyHub Datasets/File29/svi_desc.txt'
cold = f'{program_path}sherlock-project-master/QGD/IndyHub Datasets/File29/svi_percentile_dict.xlsx'
                ...
                while counter in range(0, 5):
                    if question_count < 20:
                        ...
                        output_data2.append({
                            ...
                            'Query String': str(sql),
                            'Column Name Template': qs[0],
                            'Column Desc Question': qs[1],
                            'Best_Version': qs[5],                
                            'Paraphrased Question': qs[2],
                            'Original ColPP Question': qs[3],
                            'Column Paraphrased Question': qs[4]
