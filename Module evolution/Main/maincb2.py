...
from questn13 import ques   # question generation 
from sql_3v import sqlqueryv3     #SQL query generation 
from questn_3v_v2 import quesv3   # question generation 
import random
from para7 import *
...
#Initializing files
filename = f'{program_path}sherlock-project-master/QGD/IndyHub Datasets/File24/CMS_OUT_2021_data.csv'
datad = f'{program_path}sherlock-project-master/QGD/IndyHub Datasets/File24/CMS_OUT_2021_dataDescription.txt'
cold = f'{program_path}sherlock-project-master/QGD/IndyHub Datasets/File24/CMS_OUT_2021_dataColumn.xlsx'
...
for index, row in combined_df.iterrows():
    if row['Original Meta Categories'] == 'year':
        ...
        if row['Data_Type'] == 'object':
            combined_df.at[index, 'Final MetaCategory'] = 'code'
            combined_df.at[index, 'Meta Category List'] = 'cat'
    elif row['Final MetaCategory'] in meta_category_lists['cat'] or row['Final MetaCategory'] in meta_category_lists['prf']:  # Check if in the "cat","prf" list
        if row['Data_Type'] == 'numeric':
            combined_df.at[index, 'Final MetaCategory'] = 'class'
            combined_df.at[index, 'Meta Category List'] = 'num'
    elif row['Original Meta Categories'] in ('birth place', 'city', 'continent', 'country', 'region'):
        if row['Data_Type'] == 'numeric':
            combined_df.at[index, 'Final MetaCategory'] = 'rank'
            combined_df.at[index, 'Meta Category List'] = 'num'
...
output_filename_initial = f"{program_path}sherlock-project-master/QGD/IndyHub Datasets/Main 11 Program Output/{folder_name}_datatype_analysis_mcb.xlsx"
...
if inp == 1:
    ...
    output_filename_initial1 = f"{program_path}sherlock-project-master/QGD/IndyHub Datasets/Main 11 Program Output/{folder_name}_questions_mcbv2_{timestamp_str}.xlsx"
    output_df1.to_excel(output_filename_initial1, index=False)

    output_filename_initial2 = f"{program_path}sherlock-project-master/QGD/IndyHub Datasets/Main 11 Program Output/{folder_name}_questions_mcbv3_{timestamp_str}.xlsx"
