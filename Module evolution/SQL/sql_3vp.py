...
def sqlqueryv3(test, sherlock_prediction, sqlcheatsheet):
    ...
    addn_combinations = [
        ("county", "num", "num"),("county", "cat", "cat"),("county", "cat", "prf"),
        ("county", "num", "prf"),("county", "num", "cat"),("county", "prf", "num"),("county", "prf", "cat"),
        ("county", "num", "loc"),("county", "cat", "loc"),("county", "prf", "loc"),("county", "date", "loc"), ("county", "year", "loc"),
        ("county", "cat", "num"),("county", "num", "date"),("county", "num", "year"),("county", "cat", "date"),("county", "cat", "year")
    ]

    combinations = addn_combinations
    
    #combinations = combinations_no_repeats + repeat_combinations + addn_combinations
    ...
    try:
        ...
        while not valid_combination and max_attempts > 0:
            ...
            if available_columns_1 and available_columns_2 and available_columns_3:
        ...
        sql.append("AND")  # Add AND statement
        ...
        chosen_map_col3 = map_col3[chosen_map_col_index3]
